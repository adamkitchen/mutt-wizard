...
```
git clone https://github.com/adamkitchen/mutt-wizard
cd mutt-wizard
sudo make install
```
...
See Adam's website [here](https://adam-kitchen.com). Email him at [adamkitchen15@gmail.com](mailto:adamkitchen15@gmail.com)
